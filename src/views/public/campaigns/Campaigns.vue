    ...
    <b-container fluid>
      <b-row>
        <b-col>
          ...
          <div>
            Les campanyes son periodes de l'any en que l'acollida posa en marxa
            un sistema de busos a l'atenció dels participants per anar a les
            encontres de Taizé sortint des de Barcelona.
          </div>
        </b-col>
      </b-row>
      <b-row class="mt-4">
      ...
      <b-row class="mt-4">
        <b-col>
          ...
          <campaign-list-item
            v-for="(item, index) in closedCampaigns"
            :key="index"
            :item="item"
          ></campaign-list-item>
        </b-col>
